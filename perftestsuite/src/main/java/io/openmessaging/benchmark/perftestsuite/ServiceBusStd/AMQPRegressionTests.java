package io.openmessaging.benchmark.perftestsuite.ServiceBusStd;
...
public class AMQPRegressionTests extends EventHubTestBase {
    ...
    public static Runnable SmallPayloadTest() {
        return new Runnable() {
            ...
            public void run() {
                arguments = new Arguments();
                arguments.drivers = Collections.singletonList("driver-azure-servicebus/amqp-batch-dedicated-v2.yaml");
                arguments.workloads = Collections.singletonList("workloads/1producer-1consumer-1MBMessage-sb.yaml");
